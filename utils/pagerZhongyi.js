...
/**
 * 基于原有pager改造，适用于中医案例网，主要对page的class进行配合设定
 */
...
exports = module.exports = {
    ...
    var result = "", resultStart = "<div class='pagination'>", start, finish;
    ...
    result += "&nbsp;跳转到: <input id='pagerGoto' type='text' name='skip' value='' class='pager-page' title='Go to a specific start point, type and enter ...' />";
